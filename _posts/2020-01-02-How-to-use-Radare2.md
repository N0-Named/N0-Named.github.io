...
> **Radare2는** 리버스 엔지니어링 툴(프레임워크)로 gdb와 같이 **동적분석을** 할 수 있다.  또한 우리에겐 매우 편리한 인터랙티브 쉘로 구성되어 있어서 리눅스에서 평소 사용하던 명령어들을 그대로 이용할 수 있다.  그리고 여러 강력한 기능을 제공하고 전부는 아니지만 최대한 많이 담아 볼 예정이다.
...
![r2 filename](N0-Named.github.io/_posts/스크린샷 2019-12-04 오후 10.09.23.png)
...
![스크린샷 2019-12-04 오후 7.43.24](N0-Named.github.io/_posts/스크린샷 2019-12-04 오후 7.43.24.png)
...
![스크린샷 2019-12-04 오후 3.49.08](N0-Named.github.io/_posts/스크린샷 2019-12-04 오후 3.49.08.png)
...
![스크린샷 2019-12-04 오후 7.53.12](N0-Named.github.io/_posts/스크린샷 2019-12-04 오후 7.53.12.png)
...
- Radare2는 **pdf**(Print Disassemble Funtion) 명령어를 제공하므로, 해당 함수의 디스어셈블리를 보고싶다면 **pdf @funcname**을 입력하면 된다. 여기서 @는 명령이 실행되는 탐색 위치를 지정하는데 사용된다. 또한, **pd**라는 명령어를 사용하면 함수가 아닌 개체를 디스어셈블 해준다. 
  ![스크린샷 2019-12-04 오후 3.49.14](N0-Named.github.io/_posts/스크린샷 2019-12-04 오후 3.49.14.png)
...
![스크린샷 2019-12-04 오후 8.02.23](N0-Named.github.io/_posts/스크린샷 2019-12-04 오후 8.02.23.png)

- hex값을 확인할때는 "**x 표시할 라인수**"를 입력해주면 해당 라인만큼의 hex값을 출력해준다. 


![스크린샷 2019-12-04 오후 3.50.20](N0-Named.github.io/_posts/스크린샷 2019-12-04 오후 3.50.20.png)
...
![스크린샷 2019-12-04 오후 8.00.17](N0-Named.github.io/_posts/스크린샷 2019-12-04 오후 8.00.17.png)

1. #### 문자열 관련 명령어들

- **axt**명령어는 해당 함수의 참조위치를 확인할 수 있는 명령어이다. **afl**명령어를 이용하여 함수의 목록을 확인 후, 이를 이용하여 참조를 확인할 수 있다.

![스크린샷 2019-12-04 오후 8.08.10](N0-Named.github.io/_posts/스크린샷 2019-12-04 오후 8.08.10.png)

**izzq~[text]**는 해당 텍스트의 위치를 바이너리 내에서 검색하는 명령어이다. 이 문제에서는 Password인증을 우회해야 하기 때문에 Password를 찾아봤다. 

![스크린샷 2019-12-04 오후 8.09.45](N0-Named.github.io/_posts/스크린샷 2019-12-04 오후 8.09.45.png)

이번에는 flagspaces를 확인할 수 있는 **fs**명령어이다. 

![스크린샷 2019-12-04 오후 8.07.21](N0-Named.github.io/_posts/스크린샷 2019-12-04 오후 8.07.21.png)
...
5. 이후에 **dc** 를 입력하면 디버깅이 종료되고 **oob** 명령어를 통해서 다시 디버깅을 시작한다.
